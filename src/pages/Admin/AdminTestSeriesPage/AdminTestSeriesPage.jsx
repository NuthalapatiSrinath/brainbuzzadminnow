...
import styles from "./AdminTestSeriesPage.module.css";
...
const AdminTestSeriesPage = () => {
  ...
  // --- CONFIG ---
  const CURRENT_SECTION = "TEST_SERIES";
  ...
  const handleBulkDelete = async () => {
    ...
    if (window.confirm(`Delete ${ids.length} categories?`)) {
      ...
      fetchData();
      setSelectedCategories(new Set()); // Clear selection after delete
    }
  };
      ...
      <div className={styles.columnsContainer}>
        {columns.length > 0 ? (
          ...
          <div className={styles.emptyState}>
            <p>
              No Test Series categories found. Click "Add Category" to start.
            </p>
          </div>
        )}
      </div>
